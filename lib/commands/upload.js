var argv = require('yargs').argv,
    ...
    versionCode = readConfig.get('erosNativeJs')['versionCode'];
...
var config = {
    ...
    options: [{
        ...
        keys: ['--ios'],
        describe: 'pack full dose zip and send to eros ios platform.'
    }, {
        keys: ['--android'],
        describe: 'pack full dose zip and send to eros android platform.'
    }, {
        keys: ['--all'],
        describe: 'pack full dose zip and send to eros android and ios platform.'
    }]
}
